...
class ApplicationFillReviewService:
            ...
            async with async_playwright() as p:
                ...
                try:
                    ...
                    if ats_type == "greenhouse":
                        ...
                        fill_result = await cls._fill_icims_page(
                            page=page,
                            application_url=application_url,
                            profile=profile,
                            resume_bytes=resume_bytes,
    ...
    async def _fill_icims_page(
        ...
        if not await cls._open_generic_apply_form(page):
            blockers.append("Could not open an iCIMS application form on this page.")
        ...
        contact_fields = [
            ...
            ("Email", ["input[name*='email' i]", "input[type='email']", "input[id*='email' i]", "input[aria-label*='email' i]"], profile.email),
            ("Phone", ["input[name*='phone' i]", "input[type='tel']", "input[id*='phone' i]", "input[aria-label*='phone' i]"], profile.phone),
            ("LinkedIn", ["input[name*='linkedin' i]", "input[id*='linkedin' i]"], profile.linkedin_url),
            ("Website", ["input[name*='portfolio' i]", "input[name*='website' i]", "input[name*='github' i]"], profile.portfolio_url or profile.github_url),
        ]
        for label, selectors, value in contact_fields:
