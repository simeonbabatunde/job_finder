...
- Added the first deterministic fill-for-review endpoint, `POST /applications/{app_id}/fill-review`, for resolved Greenhouse, Lever, Ashby, SmartRecruiters, Workday, and BambooHR applications.
...
- Expand deterministic ATS coverage beyond Greenhouse, Lever, Ashby, SmartRecruiters, Workday, and BambooHR, starting with fixture-driven research for iCIMS.
