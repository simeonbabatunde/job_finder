...
- Fill-for-review adapters are implemented for resolved Greenhouse, Lever, Ashby, SmartRecruiters, Workday, BambooHR, and iCIMS links via `POST /applications/{app_id}/fill-review`.
...
2. Expand deterministic ATS coverage beyond Greenhouse, Lever, Ashby, SmartRecruiters, Workday, BambooHR, and iCIMS, starting with fixture-driven research for Recruitee or Taleo.
